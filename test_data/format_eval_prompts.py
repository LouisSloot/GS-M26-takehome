...
Loads from test_data_outputs/expanded/{category}/{n}_turn/{harmful,unharmful}_prompts.csv
and writes to test_data_outputs/formatted/1_turn.jsonl, 2_turn.jsonl, 3_turn.jsonl.

No sampling—turn and label are determined by the directory structure.

Usage:
  python test_data/format_eval_prompts.py
  python test_data/format_eval_prompts.py --input-dir /path/to/expanded --output-dir /path/to/formatted
"""
...
DEFAULT_INPUT = REPO_ROOT / "test_data_outputs" / "expanded"
DEFAULT_OUTPUT = REPO_ROOT / "test_data_outputs" / "formatted"
