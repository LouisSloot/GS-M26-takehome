...
Outputs to data/test_data/{category}/{n}_turn/{harmful|unharmful}_prompts.csv
...
Usage:
  python data_generation/test_scripts/generate_eval_seeds.py
  python data_generation/test_scripts/generate_eval_seeds.py --max_categories 2  # test on 2 categories
  python data_generation/test_scripts/generate_eval_seeds.py --batch_size 10 --dry_run
"""
...
def main() -> int:
    ...
    parser.add_argument(
        "--output_dir",
        type=Path,
        default=Path(__file__).resolve().parent.parent.parent / "data" / "test_data",
        help="Output directory (default: data/test_data)",
    )
    parser.add_argument(
        "--batch_size",
        type=int,
