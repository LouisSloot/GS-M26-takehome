...
Usage:
  ...
  python eval/eval_deberta.py --model_path models/deberta_finetuned/checkpoint-2200
  python eval/eval_deberta.py --model_path models/deberta_finetuned --max_samples 500
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help=f"Directory containing test.jsonl (default: eval/data)",
    )
    parser.add_argument(
        "--files",
        nargs="+",
        default=["test"],
        help="JSONL filenames without .jsonl (default: test)",
    )
    parser.add_argument(
        "--batch_size",
        type=int,
